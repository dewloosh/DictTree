...
class DictTree(dict):
    ...
    def lock(self):
        """
        Locks the layout of the dictionary. If a `DictTree` is locked,
    ...
    def unlock(self):
        """
        Releases the layout of the dictionary. If a `DictTree` is not locked,
